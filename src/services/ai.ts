 ...
 */
export const generateCoverLetter = async (studentProfile: any, jobPosting: any): Promise<string> => {
  const prompt = `
    ...
    Highlight relevant skills and experiences. The tone should be enthusiastic and professional.
